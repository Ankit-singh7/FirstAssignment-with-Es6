var PokemonInformation={
 ...
 //FUNCTION FOR FINDING POKEMONS WHO HAVE THAT NAME IN THEIR NEXT EVOLUTION FIELD
function namesInNextEvolutionField(pokemonName)
{     
    var indexCount;
	var pokArray=PokemonInformation.pokemon;
     for (indexCount in pokArray) 
	 {
        var nextEvolutionArray=pokArray[indexCount].next_evolution;
		
        if (nextEvolutionArray)
        {
			
          for(evolutionIndex in nextEvolutionArray)
			  
             {
		
               if(nextEvolutionArray[evolutionIndex].name==pokemonName)
				   
                {
			
              alert(pokemonName+" is present in the NEXT EVOLUTION OF :"+pokArray[indexCount].name);
	...
	var pokemonName=prompt("Enter the name of the pokemon you want search in the Next Evolution of other pokemon-");
     	
		namesInNextEvolutionField(pokemonName);
