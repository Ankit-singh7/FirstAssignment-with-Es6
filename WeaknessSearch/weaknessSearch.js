...
//FUNCTION TO FIND THE POKEMON HAVING SAME WEAKNESS	
function findingPokemonHavingSameWeakness(weakness)
{
...
{
	var weaknessArray=pokArray[indexCount].weaknesses;
	if(weaknessArray)
	{   
       for(weaknessIndex in weaknessArray)
	   {
		   if(weaknessArray[weaknessIndex]==weakness)
		   {
			   alert("This weakness is common in- "+pokArray[indexCount].name);
		   }
	   }
	}
}
}
var weakness=prompt("Enter the weakness -");

	findingPokemonHavingSameWeakness(weakness);
