...
//FUNCTION FOR FINDING POKEMON DETAILS STARTS AFTER THIS COMMENT
function InfoAboutPokemon(findPokemon)
{
	
	var count;
	var pokemonFound=false;
	var pokArray=PokemonInformation.pokemon;
	for(count in pokArray)
	{
		if(pokArray[count].name==findPokemon)
	{
		pokemonFound=true;
		break;
	}
	...
	{
		alert("Id: "+pokArray[count].id+"\n"+"Num: "+pokArray[count].num+"\n"+"Name: "+pokArray[count].name+"\n"+
		"Image: "+pokArray[count].img+"\n"+"Type: "+"(i)"+pokArray[count].type[0]+"  (ii)"+pokArray[count].type[1]+"\n"+
		"Height: "+pokArray[count].height+"\n"+"Weight: "+pokArray[count].weight+"\n"+"Candy: "+pokArray[count].candy+"\n"+
		"Egg: "+pokArray[count].egg+"\n"+"Spawn Chance: "+pokArray[count].spawn_chance+"\n"+"Average Spawn: "+pokArray[count].avg_spawns+"\n"+
		"Spawn Time: "+pokArray[count].spawn_time+"\n"+"Multiplayer: "+pokArray[count].multipliers+"\n"+"Weakness: "+"(i)"+pokArray[count].weaknesses[0]+
		" (ii)"+pokArray[count].weaknesses[1]+" (iii)"+pokArray[count].weaknesses[2]+"\n"+"THANK YOU FOR VISITING!");
	...
	var pokemonName=prompt("Enter the name of pokemon you want to know about-");
	InfoAboutPokemon(pokemonName);
